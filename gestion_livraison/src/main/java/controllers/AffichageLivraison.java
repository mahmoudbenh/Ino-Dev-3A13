...
public class AffichageLivraison {
    ...
    private ServiceLivraison ServLiv = new ServiceLivraison();
        ...
        @FXML
        void AnnulerLivraison(ActionEvent event) {
    ...
    @FXML
    void initialize() {
        assert LivraisonContainer != null : "fx:id=\"LivraisonContainer\" was not injected: check your FXML file 'AffichageLivraison.fxml'.";
        assert idrecher != null : "fx:id=\"idrecher\" was not injected: check your FXML file 'AffichageLivraison.fxml'.";
