...
public class FrontController {
    ...
    void BackHome(ActionEvent event) {
        try {
            // Charger le fichier FXML du menu dynamique des développeurs
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/MenuDynamicDevelopers.fxml"));
            Parent root = loader.load();

            // Créer une nouvelle scène avec le contenu du menu dynamique des développeurs
            ...
            e.printStackTrace(); // Gérer l'exception si le chargement du fichier FXML échoue
        }
    }
